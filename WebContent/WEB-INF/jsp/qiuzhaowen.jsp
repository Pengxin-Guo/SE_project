					...
					<td class="box_right">
						...
						<div class="c_top">
							<ul class="nav_01">
							    ...
							    <li><A href='qiuzhaowen' class='navigation_style'>邱兆文</a></li>
							</ul>
				        ...
				        <tbody>
				       <tr>
                      <td align="center"><span class="menu_title"><span style="font-size:18px">邱兆文</span>&nbsp;&nbsp;副教授&nbsp;&nbsp;&nbsp;&nbsp;相关介绍</span></td>
                    </tr>
                    <tr>
                      <td style="padding-top:10px"><p>
                          <p align=center><img class=thumbImage2 border='0' src='resources/images/qiuzhaowen.jpg'></p>
                        </p>
                        <p><P><!--StartFragment-->
						<P class=p style="BACKGROUND: rgb(255,255,255); WORD-BREAK: break-all; TEXT-ALIGN: justify; MARGIN: 0pt; TEXT-JUSTIFY: inter-ideograph; LINE-HEIGHT: 24pt; TEXT-INDENT: 21pt; mso-pagination: widow-orphan" align=justify><SPAN style="FONT-SIZE: 10.5pt; FONT-FAMILY: 宋体; BACKGROUND: rgb(255,255,255); COLOR: rgb(0,0,0); mso-ascii-font-family: Calibri; mso-hansi-font-family: Calibri; mso-font-kerning: 0.0000pt; mso-bidi-font-family: 'Times New Roman'; mso-spacerun: 'yes'; mso-shading: rgb(255,255,255)"><SPAN style='FONT-SIZE: 10.5pt; FONT-FAMILY: 宋体; mso-fareast-font-family: 宋体; mso-font-kerning: 0pt; mso-bidi-font-family: "Songti SC Regular"; mso-ascii-theme-font: minor-fareast; mso-fareast-theme-font: minor-fareast; mso-hansi-theme-font: minor-fareast'>邱兆文，博士，副教授，硕士生导师。美国卡内基梅隆大学访问学者。中国计算机学会理事。黑龙江拓盟科技有限公司董事长。主要研究方向为医学影像处理、多媒体信息检索、机器学习等。主持参加国家自然科学基金、省科技攻关重点项目、省归国留学人员基金、国家发改委产业化基金、国家工信部产业化基金等 17 项。国家发明专利 3 项，软件著作权 5 项。主编专著 1 部。荣获省科技进步三等奖 1 项，市科技进步一等奖 1 项，第五届中国创新创业大赛黑龙江省赛区第一名，第五届中国创新创业大赛互联网及移动互联网行业企业组第三名 。主要科研成果拓盟医学影像处理系统可以对CT、MR等数据进行精准三维重建，生成可3D打印的模型文件，可用于病情诊断、医患沟通、手术方案规划、手术效果评估等 。<BR>&nbsp;&nbsp; <STRONG>所在学科：</STRONG>计算机应用技术 计算机技术（专业学位）<BR>&nbsp;&nbsp; <STRONG>Email：</STRONG><A href="mailto:1216649568@qq.com">qiuzw@nefu.edu.cn</A> </SPAN></SPAN></P></p>
