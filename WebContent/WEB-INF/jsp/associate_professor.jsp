					...
					<td class="box_right">
						...
						<div class="c_top">
							<ul class="nav_01">
								...
								<li><A href='associate_professor' class='navigation_style'>副教授</a></li>
							</ul>
						</div> <!-- c_bottom end --> <!-- c_bottom end --> <!-- start -->
				        <div class="box_detail"><h1 style="margin: 0px 0px 20px; padding: 0px 4px 0px 0px; text-align: center; font-size: 28px; font-weight: bold; border-bottom-color: rgb(204, 204, 204); border-bottom-width: 2px; border-bottom-style: solid;" label="标题居中">副教授</h1>
				        <p>&nbsp;</p>
				        <table width="576" align="center" border="0" cellspacing="0" cellpadding="0" uetable="null">
				        <tbody>
				        <tr class="firstRow">
				        <td width="180" style="border-color: rgb(0, 0, 0); text-align: center;"><a href="luosiqing" ><img width="148" height="204" alt="" src="resources/images/luosiqing.png"/></a></td>
				        <td width="180" style="border-color: rgb(0, 0, 0); text-align: center;"><a href="lili" ><img width="148" height="204" alt="" src="resources/images/lili.jpg"/></a></td>
				        <td width="180" style="border-color: rgb(0, 0, 0); text-align: center;"><a href="liudan" ><img width="148" height="204" alt="" src="resources/images/liudan.jpg"/></a></td>
				        </tr>
				        <tr>
				        <td style="text-align: center;"><a href="luosiqing"  style="color: black;"><span style="font-size: 14px;">罗嗣卿</span></a></td>
				        <td style="text-align: center;"><a href="lili"  style="color: black;"><span style="font-size: 14px;">李莉</span></a></td>
				        <td style="text-align: center;"><a href="liudan"  style="color: black;"><span style="font-size: 14px;">刘丹</span></a></td>
				        </tr>
				        <tr><td>&nbsp;</td></tr>
				        <tr class="firstRow">
				        <td width="180" style="border-color: rgb(0, 0, 0); text-align: center;"><a href="zhangxiying" ><img width="148" height="204" alt="" src="resources/images/zhangxiying.jpg"/></a></td>
				        <td width="180" style="border-color: rgb(0, 0, 0); text-align: center;"><a href="qiuzhaowen" ><img width="148" height="204" alt="" src="resources/images/qiuzhaowen.jpg"/></a></td>
				        </tr>
				        <tr>
				        <td style="text-align: center;"><a href="zhangxiying"  style="color: black;"><span style="font-size: 14px;">张锡英</span></a></td>
				        <td style="text-align: center;"><a href="qiuzhaowen"  style="color: black;"><span style="font-size: 14px;">邱兆文</span></a></td>
				        </tr>
				        </tbody>
				        </table>
				        <p>&nbsp;</p>
