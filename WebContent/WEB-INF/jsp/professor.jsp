			...
			<table width="0" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td class="box_right">
				        ...
				        <div class="box_detail"><h1 style="margin: 0px 0px 20px; padding: 0px 4px 0px 0px; text-align: center; font-size: 28px; font-weight: bold; border-bottom-color: rgb(204, 204, 204); border-bottom-width: 2px; border-bottom-style: solid;" label="标题居中">教授</h1>
				        <p>&nbsp;</p>
				        <table width="576" align="center" border="0" cellspacing="0" cellpadding="0" uetable="null">
				        <tbody>
				        <tr class="firstRow">
				        <td width="180" style="border-color: rgb(0, 0, 0); text-align: center;"><a href="sujianmin" ><img width="148" height="204" alt="" src="resources/images/sujianmin.jpg"/></a></td>
				        </tr>
				        <tr>
				        <td style="text-align: center;"><a href="sujianmin"  style="color: black;"><span style="font-size: 14px;">苏建民</span></a></td>
				        </tr>
				        </tbody>
				        </table>
				        <p>&nbsp;</p>
