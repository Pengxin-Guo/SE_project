					...
					<td class="box_right">
						...
						<div class="c_top">
							<ul class="nav_01">
								...
								<li><A href='lecturer' class='navigation_style'>讲师</a></li>
							</ul>
						</div> <!-- c_bottom end --> <!-- c_bottom end --> <!-- start -->
				        <div class="box_detail"><h1 style="margin: 0px 0px 20px; padding: 0px 4px 0px 0px; text-align: center; font-size: 28px; font-weight: bold; border-bottom-color: rgb(204, 204, 204); border-bottom-width: 2px; border-bottom-style: solid;" label="标题居中">讲师</h1>
				        <p>&nbsp;</p>
				        <table width="576" align="center" border="0" cellspacing="0" cellpadding="0" uetable="null">
				        <tbody>
				        <tr class="firstRow">
				        <td width="180" style="border-color: rgb(0, 0, 0); text-align: center;"><a href="liyan" ><img width="148" height="204" alt="" src="resources/images/liyan.jpg"/></a></td>
				        <td width="180" style="border-color: rgb(0, 0, 0); text-align: center;"><a href="zhaoyuming" ><img width="148" height="204" alt="" src="resources/images/zhaoyuming.jpg"/></a></td>
				        <td width="180" style="border-color: rgb(0, 0, 0); text-align: center;"><a href="wangbo" ><img width="148" height="204" alt="" src="resources/images/wangbo.jpg"/></a></td>
				        </tr>
				        <tr>
				        <td style="text-align: center;"><a href="liyan"  style="color: black;"><span style="font-size: 14px;">李琰</span></a></td>
				        <td style="text-align: center;"><a href="zhaoyuming"  style="color: black;"><span style="font-size: 14px;">赵玉茗</span></a></td>
				        <td style="text-align: center;"><a href="wangbo"  style="color: black;"><span style="font-size: 14px;">王波</span></a></td>
				        </tr>
				        <tr><td>&nbsp;</td></tr>
				        <tr class="firstRow">
				        <td width="180" style="border-color: rgb(0, 0, 0); text-align: center;"><a href="bianjilong" ><img width="148" height="204" alt="" src="resources/images/bianjilong.jpg"/></a></td>
				        <td width="180" style="border-color: rgb(0, 0, 0); text-align: center;"><a href="shanying" ><img width="148" height="204" alt="" src="resources/images/shanying.jpg"/></a></td>
				        </tr>
				        <tr>
				        <td style="text-align: center;"><a href="bianjilong"  style="color: black;"><span style="font-size: 14px;">边继龙</span></a></td>
				        <td style="text-align: center;"><a href="shanying"  style="color: black;"><span style="font-size: 14px;">单颖</span></a></td>
				        </tr>
				        </tbody>
				        </table>
				        <p>&nbsp;</p>
