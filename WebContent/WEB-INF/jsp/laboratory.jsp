			...
			<table width="0" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td class="box_right">
				        ...
				        <div class="box_detail"><h1 style="margin: 0px 0px 20px; padding: 0px 4px 0px 0px; text-align: center; font-size: 28px; font-weight: bold; border-bottom-color: rgb(204, 204, 204); border-bottom-width: 2px; border-bottom-style: solid;" label="标题居中">实验室</h1>
				        <p>&nbsp;</p>
				        <table width="576" align="center" border="0" cellspacing="0" cellpadding="0" uetable="null">
				        <tbody>
				        <tr class="firstRow">
				        <td width="180" style="border-color: rgb(0, 0, 0); "><a href="laboratory923" ><img width="306" height="204" alt="" src="resources/images/laboratory923.jpg"/></a></td>				        
				        <td style=""><a href="laboratory923"  style="color: black;text-decoration: none"><span style="font-size: 20px;">&nbsp;&nbsp;923 创新实验室</span></a></td>
				        </tr>
				        <tr><td>&nbsp;</td></tr>
				        <tr><td>&nbsp;</td></tr>
				        <tr class="firstRow">
				        <td width="180" style="border-color: rgb(0, 0, 0); "><a href="laboratory925" ><img width="306" height="204" alt="" src="resources/images/laboratory925.jpg"/></a></td>				        
				        <td style=""><a href="laboratory925"  style="color: black;text-decoration: none"><span style="font-size: 20px;">&nbsp;&nbsp;925 移动开发实验室</span></a></td>
				        </tr>
				        </tbody>
				        </table>
				        <p>&nbsp;</p>
