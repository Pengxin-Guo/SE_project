				...
				<tr>
					...
					<td class="box_right">
				        ...
				        <div class="box_detail">
				        	<h1 style="text-align: center;"><span style="font-size: 22px;"><span style="font-family: 黑体;">后台管理功能</span></span></h1>
				        	<p style="text-align: center;">&nbsp;</p>
				        	<ul class=" list-paddingleft-2">
				        	<li><p style="text-align: center;"><A href='add_news' class='navigation_style' style="text-decoration: none;color: black;font-size: 15px">添加新闻</a></p></li>
				        	<li><p style="text-align: center;"><A href='modify_news' class='navigation_style' style="text-decoration: none;color: black;font-size: 15px">修改新闻</a></p></li>
				        	<li><p style="text-align: center;"><A href='delete_news' class='navigation_style' style="text-decoration: none;color: black;font-size: 15px">删除新闻</a></p></li>				        	
				        	</ul>
				        </div>
