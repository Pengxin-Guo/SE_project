					...
					<td class="box_right">
						...
						<div class="c_top">
							<ul class="nav_01">
								...
								<li><A href='teachers' class='navigation_style'>教职工目录</a></li>
							</ul>
						</div> <!-- c_bottom end --> <!-- c_bottom end --> <!-- start -->
				        <div class="box_detail">
				        	<h1 style="text-align: center;"><span style="font-size: 22px;"><span style="font-family: 黑体;">软件工程专业在职教师名录</span></span></h1>
				        	<p style="text-align: center;">（2018年12月更新）</p>
				        	<ul class=" list-paddingleft-2">
				        	<li><p>教 &nbsp;&nbsp;授：<a href="sujianmin">苏健民</a></p></li>
				        	<li><p>副教授：<a href="luosiqing">罗嗣卿</a>， <a href="lili">李 莉</a>， <a href="liudan">刘 丹</a>，<a href="zhangxiying">张锡英</a>，<a href="qiuzhaowen">邱兆文</a></p></li>
				        	<li><p>讲 &nbsp;&nbsp;师：<a href="liyan">李 琰</a>， <a href="zhaoyuming">赵玉茗</a>， <a href="wangbo">王 波</a>，<a href="bianjilong">边继龙</a>，<a href="shanying">单 颖</a></p></li>
				        	</ul>
				        </div>
