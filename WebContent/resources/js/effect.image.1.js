    ...
    dk_slideplayer = function(object,config){
		...
		this.resetclass =function(obj,i){
            $(obj).css({
				...
				display: "block", 
				cursor: "pointer", 
				background: "url(\"resources/images/controlls.gif\") no-repeat scroll center bottom transparent", 
				float: "left", 
				outline: "medium none",
				"text-indent":"-9999px",
				display:"block"
			...
			$(obj).eq(i).css({
				background:"url(\"resources/images/controlls.gif\") no-repeat scroll center top transparent"
			});
        }
        /*
		this.resetclass =function(obj,i){
